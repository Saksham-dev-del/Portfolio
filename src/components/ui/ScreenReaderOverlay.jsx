    ...
    return (
        <div className="sr-overlay" role="complementary" aria-label="Accessible navigation for 3D portfolio">
            ...
            <nav id="sr-main-nav" className="sr-only" aria-label="Portfolio rooms">
                <h1>Saksham Saxena — AI/ML Engineer Portfolio</h1>
                <h2>Portfolio Navigation</h2>

                {!hasEntered && (
                    <p>Welcome to Saksham's interactive 3D portfolio. Click or press Enter on the doors to enter.</p>
                )}
                ...
                {hasEntered && !isInRoom && (
                    <>
                        ...
                        <ul>
                            ...
                            <li>
                                <button onClick={() => teleportTo('resume')} type="button">
                                    Resume — My experience, at a glance
                                </button>
                            </li>
                            <li>
                                <button onClick={() => teleportTo('blog')} type="button">
