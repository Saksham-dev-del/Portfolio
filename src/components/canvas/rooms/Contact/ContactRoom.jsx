    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="LINKEDIN"
                onClick={() => window.open('https://www.linkedin.com/in/saksham-saxena-cse', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="GITHUB"
                onClick={() => window.open('https://github.com/Saksham-dev-del', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* EMAIL */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="EMAIL"
                onClick={() => window.open('mailto:saxenasaksham5555@gmail.com', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* PROJECTS (extra repos) */}
            <SocialBarrel
                position={isMobile ? [1.5, -0.3, -7] : [5, -0.3, -8]}
                rotation={[0, -0.3, 0]}
                texturePath="/textures/contact/beczka.webp"
                label="PROJECTS"
                onClick={() => window.open('https://github.com/Saksham-dev-del?tab=repositories', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
