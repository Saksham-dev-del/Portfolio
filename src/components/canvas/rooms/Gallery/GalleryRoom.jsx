...
const UNIQUE_PROJECTS = [
    {
        ...
        front: '/textures/gallery/fakemedprzod.webp',
        painted: '/textures/gallery/fakemedprzod_painted.webp',
        url: 'https://github.com/Saksham-dev-del/Fake-Medicine-Detector-System',
        description: 'An AI-based fake medicine detection system that uses image-based medicine verification with deep learning. Uses Grad-CAM for explainability and is served through a FastAPI backend with a Streamlit interface.',
        techStack: ['/textures/gallery/pytorchlogo.webp', '/textures/gallery/fastapilogo.webp', '/textures/gallery/pythonlogo.webp', '/textures/gallery/dockerlogo.webp']
    },
    {
        id: 'ragassistant',
        title: 'DOCUMENT QA RAG ASSISTANT',
        front: '/textures/gallery/ragassistantprzod.webp',
        painted: '/textures/gallery/ragassistantprzod_painted.webp',
        url: 'https://github.com/Saksham-dev-del/Document_QA_RAG_Assistant',
        description: 'An AI-powered document Q&A assistant for PDF-based question answering using Retrieval-Augmented Generation, grounded answers, LangChain, FAISS, and the OpenAI API.',
        techStack: ['/textures/gallery/langchainlogo.webp', '/textures/gallery/pythonlogo.webp', '/textures/gallery/fastapilogo.webp', '/textures/gallery/dockerlogo.webp']
    },
    {
        id: 'deepfake',
        title: 'DEEPFAKE AUDIO DETECTOR',
        front: '/textures/gallery/deepfakeprzod.webp',
        painted: '/textures/gallery/deepfakeprzod_painted.webp',
        url: 'https://github.com/Saksham-dev-del/Deepfake_Fake_Audio_Detection_System',
        description: 'An Android + AI/ML system for detecting deepfake or fake audio using audio feature extraction (MFCC, Librosa) and CNN/TensorFlow Lite model inference, served via FastAPI.',
        techStack: ['/textures/gallery/kotlinlogo.webp', '/textures/gallery/tensorflowlogo.webp', '/textures/gallery/pythonlogo.webp', '/textures/gallery/fastapilogo.webp']
    },
    {
        id: 'n8nsuite',
        title: 'N8N AUTOMATION SUITE',
        front: '/textures/gallery/n8nsuiteprzod.webp',
        painted: '/textures/gallery/n8nsuiteprzod_painted.webp',
        url: 'https://github.com/Saksham-dev-del?tab=repositories',
        description: 'A set of n8n automation workflows: order-to-invoice processing with Airtable + Twilio WhatsApp, an RSS-to-email news digest, a Gmail inbox logger, and a daily WhatsApp weather report bot.',
        techStack: ['/textures/gallery/n8nlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/firebaselogo.webp']
    },
];
...
const GalleryRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const allLogos = useMemo(() => {
        const names = [
            ...
            'pythonlogo', 'pytorchlogo', 'tensorflowlogo', 'fastapilogo',
            'dockerlogo', 'langchainlogo', 'n8nlogo', 'kotlinlogo'
        ];
