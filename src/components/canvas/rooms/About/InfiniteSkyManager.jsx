...
const AWARDS_DATA = {
    featured: {
        ...
        items: [
            { label: 'Fake Medicine Detector', date: '2026', image: '/textures/about/proj_fakemed.webp', url: 'https://github.com/Saksham-dev-del/Fake-Medicine-Detector-System' },
            { label: 'Document QA RAG Assistant', date: '2026', image: '/textures/about/proj_rag.webp', url: 'https://github.com/Saksham-dev-del/Document_QA_RAG_Assistant' },
            { label: 'Deepfake Audio Detector', date: '2026', image: '/textures/about/proj_deepfake.webp', url: 'https://github.com/Saksham-dev-del/Deepfake_Fake_Audio_Detection_System' },
            { label: 'n8n Automation Suite', date: '2026', image: '/textures/about/proj_n8n.webp', url: 'https://github.com/Saksham-dev-del?tab=repositories' },
        ],
        platformConfig: {
            label: 'HONOR',
            color: '#1a1a1a',
    ...
    sotd: {
        ...
        items: [
            { label: 'Fake Medicine Detector System', date: '2026', image: '/textures/about/proj_fakemed.webp', url: 'https://github.com/Saksham-dev-del/Fake-Medicine-Detector-System' },
            { label: 'Document QA RAG Assistant', date: '2026', image: '/textures/about/proj_rag.webp', url: 'https://github.com/Saksham-dev-del/Document_QA_RAG_Assistant' },
            { label: 'Deepfake Audio Detection System', date: '2026', image: '/textures/about/proj_deepfake.webp', url: 'https://github.com/Saksham-dev-del/Deepfake_Fake_Audio_Detection_System' },
            { label: 'n8n Automation Workflows', date: '2026', image: '/textures/about/proj_n8n.webp', url: 'https://github.com/Saksham-dev-del?tab=repositories' },
        ],
        platformConfig: {
            label: 'PROJECT',
            color: '#1a1a1a',
    ...
    soty: {
        ...
        title: 'Goals',
        items: [
            { label: 'Land an AI/ML Internship', date: 'Next', image: '/textures/about/goal_intern.webp', url: 'https://www.linkedin.com/in/saksham-saxena-cse' },
            { label: 'Contribute to Open Source ML Projects', date: 'Ongoing', image: '/textures/about/goal_oss.webp', url: 'https://github.com/Saksham-dev-del' },
            { label: 'Build & Ship a Production GenAI Product', date: 'Future', image: '/textures/about/goal_genai.webp', url: 'https://github.com/Saksham-dev-del' },
            { label: 'Grow as a Full-Time AI/ML Engineer', date: 'Long-term', image: '/textures/about/goal_career.webp', url: 'https://www.linkedin.com/in/saksham-saxena-cse' },
        ],
        platformConfig: {
            label: 'GOAL',
            color: '#1a1a1a',
...
const BALLOON_CONFIG = [
    // Large balloons (core stack) - front and center
    ...
    { texture: '/textures/about/tensorflowbalon.webp', paintedTexture: '/textures/about/tensorflowbalon_painted.webp', label: 'TensorFlow', size: 'large', x: 2.5, y: 2.5, z: 0.2, phase: 1.5 },
    { texture: '/textures/about/pytorchbalon.webp', paintedTexture: '/textures/about/pytorchbalon_painted.webp', label: 'PyTorch', size: 'large', x: 0, y: 3, z: 0.5, phase: 3 },
    { texture: '/textures/about/reactbalon.webp', paintedTexture: '/textures/about/reactbalon_painted.webp', label: 'React', size: 'large', x: -1, y: 3.6, z: 0.1, phase: 0.5 },

    // Medium balloons - scattered around
    { texture: '/textures/about/langchainbalon.webp', paintedTexture: '/textures/about/langchainbalon_painted.webp', label: 'LangChain', size: 'medium', x: -4, y: 1, z: -0.3, phase: 0.8 },
    { texture: '/textures/about/dockerbalon.webp', paintedTexture: '/textures/about/dockerbalon_painted.webp', label: 'Docker', size: 'medium', x: 4, y: 1.5, z: -0.2, phase: 2.2 },
    { texture: '/textures/about/scikitlearnbalon.webp', paintedTexture: '/textures/about/scikitlearnbalon_painted.webp', label: 'Scikit-Learn', size: 'medium', x: 0, y: 0.5, z: -0.4, phase: 4 },
    { texture: '/textures/about/mysqlbalon.webp', paintedTexture: '/textures/about/mysqlbalon_painted.webp', label: 'MySQL', size: 'medium', x: 1.8, y: 4.2, z: -0.3, phase: 1.8 },

    // Small balloons - background accents
    { texture: '/textures/about/gitbalon.webp', paintedTexture: '/textures/about/gitbalon_painted.webp', label: 'Git', size: 'small', x: -5.5, y: 2.5, z: -0.8, phase: 1.2 },
    { texture: '/textures/about/n8nbalon.webp', paintedTexture: '/textures/about/n8nbalon_painted.webp', label: 'n8n', size: 'small', x: 5.5, y: 3, z: -0.7, phase: 2.8 },
    { texture: '/textures/about/numpybalon.webp', paintedTexture: '/textures/about/numpybalon_painted.webp', label: 'NumPy', size: 'small', x: -3, y: 4.5, z: -0.5, phase: 3.5 },
    { texture: '/textures/about/pandasbalon.webp', paintedTexture: '/textures/about/pandasbalon_painted.webp', label: 'Pandas', size: 'small', x: 3.5, y: 4, z: -0.6, phase: 4.5 },
    { texture: '/textures/about/javascriptbalon.webp', paintedTexture: '/textures/about/javascriptbalon_painted.webp', label: 'JavaScript', size: 'small', x: -4.5, y: 0.2, z: -0.6, phase: 2.5 },
    { texture: '/textures/about/fastapibalon.webp', paintedTexture: '/textures/about/fastapibalon_painted.webp', label: 'FastAPI', size: 'small', x: 4.8, y: 0.4, z: -0.5, phase: 3.8 },
];
