...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'SAKSHAM', subtitle: '< AI/ML enthusiast />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'HIGHLIGHTS', subtitle: 'AI/ML • GenAI • Automation projects' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'Computer Science Engineering' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'Python • TensorFlow • PyTorch • React' },
];
